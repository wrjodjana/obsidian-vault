...
- **Action:** I decided on using the K-means clustering approach over more complex unsupervised learning prioritizing interpretability and fast implementation. Furthermore, instead of experimenting with multiple architecture I used existing implementations that the previous re